...
namespace MusicShop.Controllers
{
    public class AdministratorsController : Controller
    {
        ...
        public AdministratorsController(MusicShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Administrator != null ? 
                          ...
                          Problem("Entity set 'MusicShopContext.Administrator'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,UserName,Password,UserType")] Administrator administrator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserName,Password,UserType")] Administrator administrator)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MusicShopContext.Administrator'  is null.");
            }
            var administrator = await _context.Administrator.FindAsync(id);
            if (administrator != null)
            {
